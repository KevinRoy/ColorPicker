...
public class OverlayView extends View {
    ...
    public OverlayView(Context context, AttributeSet attrs) {
        ...
        final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.WaterWaveLayout);
        holeradius=attributes.getDimensionPixelSize(R.styleable.WaterWaveLayout_holeRadius,getDimensionInPixel(60));
        mMachineColor=attributes.getColor(R.styleable.WaterWaveLayout_machineColor, Color.BLACK);
        attributes.recycle();
    }
